...
<main class="main">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="about-left wow fadeInLeft" data-wow-delay=".25s">
                            <div class="about-img">
                                <div class="img-1">
                                    <img src="<?= base_url('assets/') ?>img/about/01.jpg" alt="">
                                </div>
                                <img class="img-2" src="<?= base_url('assets/') ?>img/about/02.jpg" alt="">
                                <img class="img-3" src="<?= base_url('assets/') ?>img/about/03.jpg" alt="">
                            </div>
                            <div class="about-experience">
                                <div class="about-experience-icon">
                                    <img src="<?= base_url('assets/') ?>img/icon/experience.svg" alt="">
                                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="about-right wow fadeInRight" data-wow-delay=".25s">
                            ...
                            <a href="<?= base_url('contact') ?>" class="theme-btn mt-4">Discover More<i
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="counter-box">
                            <div class="icon">
                                <img src="<?= base_url('assets/') ?>img/icon/sale.svg" alt="">
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="counter-box">
                            <div class="icon">
                                <img src="<?= base_url('assets/') ?>img/icon/rate.svg" alt="">
                            </div>
                            <div class="counter-info">
                                <div class="counter-amount">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="counter-box">
                            <div class="icon">
                                <img src="<?= base_url('assets/') ?>img/icon/employee.svg" alt="">
                            </div>
                            <div class="counter-info">
                                <div class="counter-amount">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="counter-box">
                            <div class="icon">
                                <img src="<?= base_url('assets/') ?>img/icon/award.svg" alt="">
                            </div>
                            <div class="counter-info">
                                <div class="counter-amount">
        ...
        <div class="video-area py-100">
            <div class="container">
                <div class="row g-4 align-items-center">
                    ...
                    <div class="col-lg-8">
                        <div class="video-content wow fadeInRight" data-wow-delay=".25s" style="<?= base_url('assets/') ?>background-image: url(<?= base_url('assets/') ?>img/video/01.jpg);">
                            <div class="row align-items-center">
                                <div class="col-lg-12">
            ...
            <div class="container">
                ...
                <div class="testimonial-slider owl-carousel owl-theme wow fadeInUp" data-wow-delay=".25s">
                    <div class="testimonial-item">
                        <div class="testimonial-author">
                            <div class="testimonial-author-img">
                                <img src="<?= base_url('assets/') ?>img/testimonial/01.jpg" alt="">
                            </div>
                        ...
                        <div class="testimonial-quote-icon"><img src="<?= base_url('assets/') ?>img/icon/quote.svg" alt=""></div>
                    </div>
                    <div class="testimonial-item">
                        <div class="testimonial-author">
                            <div class="testimonial-author-img">
                                <img src="<?= base_url('assets/') ?>img/testimonial/02.jpg" alt="">
                            </div>
                            <div class="testimonial-author-info">
                                <h4>Gordo Novak</h4>
                                <p>Customer</p>
                    ...
                    <div class="testimonial-item">
                        <div class="testimonial-author">
                            <div class="testimonial-author-img">
                                <img src="<?= base_url('assets/') ?>img/testimonial/03.jpg" alt="">
                            </div>
                            <div class="testimonial-author-info">
                                <h4>Reid E Butt</h4>
                                <p>Customer</p>
                    ...
                    <div class="testimonial-item">
                        <div class="testimonial-author">
                            <div class="testimonial-author-img">
                                <img src="<?= base_url('assets/') ?>img/testimonial/04.jpg" alt="">
                            </div>
                            <div class="testimonial-author-info">
                    ...
                    <div class="testimonial-item">
                        <div class="testimonial-author">
                            <div class="testimonial-author-img">
                                <img src="<?= base_url('assets/') ?>img/testimonial/05.jpg" alt="">
                            </div>
                            <div class="testimonial-author-info">
                                <h4>Heruli Nez</h4>
                                <p>Customer</p>
                ...
                <div class="row mt-5">
                    <div class="col-md-6 col-lg-3">
                        <div class="team-item wow fadeInUp" data-wow-delay=".25s">
                            <div class="team-img">
                                <img src="<?= base_url('assets/') ?>img/team/01.jpg" alt="thumb">
                            </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="team-item wow fadeInUp" data-wow-delay=".50s">
                            <div class="team-img">
                                <img src="<?= base_url('assets/') ?>img/team/02.jpg" alt="thumb">
                            </div>
                            <div class="team-content">
                                <div class="team-bio">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="team-item wow fadeInUp" data-wow-delay=".75s">
                            <div class="team-img">
                                <img src="<?= base_url('assets/') ?>img/team/03.jpg" alt="thumb">
                            </div>
                            <div class="team-content">
                                <div class="team-bio">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="team-item wow fadeInUp" data-wow-delay="1s">
                            <div class="team-img">
                                <img src="<?= base_url('assets/') ?>img/team/04.jpg" alt="thumb">
                            </div>
                            <div class="team-content">
                                <div class="team-bio">
        ...
        <!-- feature area -->
        <div class="feature-area pt-50 pb-100">
        ...
        <div class="instagram-area pb-100">
            <div class="container wow fadeInUp" data-wow-delay=".25s">
                <div class="row">
                    <div class="col-lg-6 mx-auto">
                        <div class="site-heading text-center">
                            <h2 class="site-title">Instagram <span>@gifoy</span></h2>
                        </div>
                    </div>
                </div>
                <div class="instagram-slider owl-carousel owl-theme">
                    <div class="instagram-item">
                        <div class="instagram-img">
                            <img src="<?= base_url('assets/') ?>img/instagram/01.jpg" alt="Thumb">
                            <a href="#"><i class="fab fa-instagram"></i></a>
                        </div>
                    </div>
                    <div class="instagram-item">
                        <div class="instagram-img">
                            <img src="<?= base_url('assets/') ?>img/instagram/02.jpg" alt="Thumb">
                            <a href="#"><i class="fab fa-instagram"></i></a>
                        </div>
                    </div>
                    <div class="instagram-item">
                        <div class="instagram-img">
                            <img src="<?= base_url('assets/') ?>img/instagram/03.jpg" alt="Thumb">
                            <a href="#"><i class="fab fa-instagram"></i></a>
                        </div>
                    </div>
                    <div class="instagram-item">
                        <div class="instagram-img">
                            <img src="<?= base_url('assets/') ?>img/instagram/04.jpg" alt="Thumb">
                            <a href="#"><i class="fab fa-instagram"></i></a>
                        </div>
                    </div>
                    <div class="instagram-item">
                        <div class="instagram-img">
                            <img src="<?= base_url('assets/') ?>img/instagram/05.jpg" alt="Thumb">
                            <a href="#"><i class="fab fa-instagram"></i></a>
                        </div>
                    </div>
                    <div class="instagram-item">
                        <div class="instagram-img">
                            <img src="<?= base_url('assets/') ?>img/instagram/06.jpg" alt="Thumb">
                            <a href="#"><i class="fab fa-instagram"></i></a>
                        </div>
                    </div>
                    <div class="instagram-item">
                        <div class="instagram-img">
                            <img src="<?= base_url('assets/') ?>img/instagram/07.jpg" alt="Thumb">
                            <a href="#"><i class="fab fa-instagram"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="container wow fadeInUp" data-wow-delay=".25s">
                ...
                <div class="brand-slider owl-carousel owl-theme">
                    <div class="brand-item">
                        <img src="<?= base_url('assets/') ?>img/brand/01.png" alt="">
                    </div>
                    <div class="brand-item">
