    ...
    <div class="site-breadcrumb">
        ...
        <div class="container">
            <div class="site-breadcrumb-wrap">
                <h4 class="breadcrumb-title"><?= esc($page_title ?? 'Shipping & Delivery Policy') ?></h4>
                <ul class="breadcrumb-menu">
                    <li><a href="<?= base_url() ?>"><i class="far fa-home"></i> Home</a></li>
                    <li class="active"><?= esc($page_title ?? 'Shipping Policy') ?></li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-12">
                    <div class="terms-content shadow-sm p-4 p-md-5 rounded border bg-white">
                        ...
                        <?php else: ?>
                            ...
                            <p>Shipping policy details will be updated soon from the backend admin panel.</p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
