                        ...
                        <div class="category-item">
                            <a href="#">
                                <div class="category-info">
                                    <div class="icon">
                                        <img src="<?= base_url('assets/') ?>img/icon/gift-box.svg" alt="">
                                    </div>
                                    <div class="content">
                                        <h4>Gifts Box</h4>
                                        <p>30 Items</p>
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="category-item">
                            <a href="#">
                                <div class="category-info">
                                    <div class="icon">
                                        <img src="<?= base_url('assets/') ?>img/icon/home.svg" alt="">
                                    </div>
                                    <div class="content">
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="category-item">
                            <a href="#">
                                <div class="category-info">
                                    <div class="icon">
                                        <img src="<?= base_url('assets/') ?>img/icon/jewelry.svg" alt="">
                                    </div>
                                    <div class="content">
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="category-item">
                            <a href="#">
                                <div class="category-info">
                                    <div class="icon">
                                        <img src="<?= base_url('assets/') ?>img/icon/garment.svg" alt="">
                                    </div>
                                    <div class="content">
                                        <h4>Garment Care</h4>
                                        <p>05 Items</p>
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="category-item">
                            <a href="#">
                                <div class="category-info">
                                    <div class="icon">
                                        <img src="<?= base_url('assets/') ?>img/icon/office.svg" alt="">
                                    </div>
                                    <div class="content">
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="category-item">
                            <a href="#">
                                <div class="category-info">
                                    <div class="icon">
                                        <img src="<?= base_url('assets/') ?>img/icon/gift.svg" alt="">
                                    </div>
                                    <div class="content">
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="category-item">
                            <a href="#">
                                <div class="category-info">
                                    <div class="icon">
                                        <img src="<?= base_url('assets/') ?>img/icon/gift-2.svg" alt="">
                                    </div>
                                    <div class="content">
